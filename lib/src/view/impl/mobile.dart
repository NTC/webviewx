...
class _WebViewXState extends State<WebViewX> {
  ...
  Widget build(BuildContext context) {
    ...
    if(controller.platform is wf_wkwebview.WebKitWebViewController) {
      (controller.platform as wf_wkwebview.WebKitWebViewController).setAllowsBackForwardNavigationGestures(widget.mobileSpecificParams.gestureNavigationEnabled);
    }
    ...
    return SizedBox(
      ...
      child: IgnorePointer(
        ...
        child: wf.WebViewWidget(
          ...
          gestureRecognizers:
              widget.mobileSpecificParams.mobileGestureRecognizers ?? Set(),
          // onPageStarted: widget.onPageStarted,
          // onPageFinished: widget.onPageFinished,
